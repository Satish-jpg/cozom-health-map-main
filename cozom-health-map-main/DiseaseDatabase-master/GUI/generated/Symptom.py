...
class Ui_Symptom(object):
    ...
    def retranslateUi(self, Symptom):
        ...
        Symptom.setWindowTitle(_translate("Symptom", "Cozom - Symptom Details"))
        self.symptom_name.setText(_translate("Symptom", "Symptom Name"))
        self.remove_button.setText(_translate("Symptom", "Remove Symptom"))
